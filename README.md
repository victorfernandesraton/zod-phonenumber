...
The chainable form is also supported with `.timezone('America/Bahia')`. Technical zones such as `UTC` and `Etc/*` are rejected. The timezone infers country/DDI only; it does not validate DDD.
